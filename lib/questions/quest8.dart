...
import 'package:covid19_TG/questions/quest9.dart';
                      ...
                      child: Container(
                          ...
                          child: Align(
                            ...
                            child: Padding(
                              ...
                              child: Text("Avez-vous ou un membre de votre famille, été en contact proche avec une personne ayant développé une fièvre inexpliquée et/ou des symptômes respiratoires ?"
                              ),
                            ),
                          )
                      )
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return InkWell(
                  ...
                  onTap: () {
                    http.post(url, body: {
                      "q8": sampleData[index].text,
                    });
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Quest9()),
                    );
                    setState(() {
